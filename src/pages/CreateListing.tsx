          ...
          <div className="md:col-span-2">
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="title" placeholder="Ex: Honda Civic 2020 em ótimo estado" />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea id="description" placeholder="Descreva seu produto ou serviço em detalhes..." rows={5} />
                    </div>
                    
                    <div className="space-y-2">
                      <Label htmlFor="location">Localização em Praia Grande</Label>
                      <Input id="location" placeholder="Ex: Boqueirão, Aviação, Centro" />
                    </div>
                    
                    <div className="space-y-2">
                      <Label htmlFor="contact">Telefone ou Email de contato</Label>
                      <Input id="contact" placeholder="Ex: (13) 99999-9999 ou email@exemplo.com" />
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <div className="flex justify-end">
                <Button type="submit" size="lg" className="bg-beach-600 hover:bg-beach-700">
                  Publicar Anúncio
                </Button>
              </div>
            </form>
